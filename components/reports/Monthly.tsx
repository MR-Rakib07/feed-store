  ...
  if (loading) {
    return (
      <View className="flex-1 justify-center items-center bg-slate-50">
        ...
        <Text className="text-slate-500 font-semibold mt-3 text-sm">Generating monthly report...</Text>
      </View>
    );
  }
  ...
  return (
    <ScrollView className="flex-1 bg-slate-50 p-4" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
      ...
      <View className="bg-emerald-600 rounded-3xl p-6 mb-4 shadow-lg shadow-emerald-200">
        <Text className="text-emerald-100 text-xs uppercase font-extrabold tracking-widest">Total Monthly Expenditure</Text>
      ...
      <Text className="text-slate-900 font-extrabold text-lg mb-3">Category Breakdown</Text>
      ...
      {categoryList.length > 0 ? (
        ...
        <View className="py-12 bg-white rounded-2xl border border-dashed border-slate-200 items-center justify-center">
          ...
          <Text className="text-slate-400 font-medium text-sm mt-2">No entries logged for this month.</Text>
        </View>
      )}
